...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:variable name="uid" select="'N20WLZM7QJ4YDK7B3XP3'"/>
    <xsl:variable name="pwd" select="'s3cr3t^p@$$word'"/>
    ...
    <xsl:template match="/">
        ...
        <dp:set-variable name="'var://service/routing-url'" value="'https://secure-test.worldpay.com/jsp/merchant/xml/paymentService.jsp'"/>
