...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:variable name="uid" select="'Delta2'"/>
  <xsl:variable name="pwd" select="'C7f7otM7He9RvrH'"/>
  ...
  <xsl:template match="/">
    ...
    <dp:set-variable name="'var://service/routing-url'" value="'http://uatgateway.americas.allianz-assistance.com/TI20Services/InsuranceOffers/Service.svc'"/>
