...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="/">
        ...
        <dp:set-variable name="'var://service/routing-url'" value="'https://partner-client.google.com/travel/boombox/test/configs/services/xml'"/>
        <dp:set-variable name="'var://service/routing-url-sslprofile'" value="'client:GoogleSSLClientProfile'"/>
