...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:variable name="uid" select="'OTA_DELTAATST1'"/>
  <xsl:variable name="pwd" select="'8CmH9MCY'"/>
  ...
  <xsl:template match="/">
    ...
    <dp:set-variable name="'var://service/routing-url'" value="'https://cis1-xmldirect.ehi.com/services30/OTA30SOAP'"/>
